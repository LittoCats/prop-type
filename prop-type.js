...
(function() {
  var array, arrayOf, arrayOfType, bool, createChainableExtractor, createPrimitiveExtractor, isArray, isObject, match, number, object, oneOf, oneOfType, shape, string,
  ...
  exports.oneOfType = oneOfType = function(extractors) {
    var extract;
    extract = function(isRequired, prop, value) {
      var e, error, extractor, i, len, result;
      if (!isRequired && value === void 0) {
        return void 0;
      }
      for (i = 0, len = extractors.length; i < len; i++) {
